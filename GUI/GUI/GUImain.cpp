...
LRESULT CALLBACK WindowProcedure(HWND hWnd, UINT msg, WPARAM wp, LPARAM lp) {
	...
	case WM_COMMAND:
		...
		case ENTER_BUTTON:
			...
			string result6Str("Total Revenue: ");
			...
			string result8Str("Total Profit: ");
